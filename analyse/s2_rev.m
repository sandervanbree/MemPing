% REVISIONS CODE
%
% Encoding phase preprocessing (retrieval was taken care of by normal
% scripts)
% SvB
...
% Parameters
pp = 34; % run once for every participant (for both res_modes)
...
%% 1: Load data
% EEG data
 load([save_path,sind,'_format'],'enc_data');
...
encoding_data_p      = data_rep;
encoding_data_comm_p = data_rep_comm;
encoding_data_lap_p  = data_rep_lap;

%% 9: save
    save([save_path,sind,'_preproc_encoding'],'data_ica','components','mschans','data_rep','missingchannel',...
        'encoding_data_p','encoding_data_comm_p','encoding_data_lap_p');
